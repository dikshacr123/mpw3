...
#         layers.Input(shape=(image_shape[0], image_shape[1], image_shape[2])),
...
# def main():
#     training_folder = r"C:\Users\gowri\OneDrive\Desktop\sample data\Train"
#     testing_folder = r"C:\Users\gowri\OneDrive\Desktop\sample data\Test"
#     time_steps = 10
...
#     conv_lstm_model = build_conv_lstm(image_shape=(224, 224, 3), time_steps=time_steps)
#     conv_lstm_model.fit(X_train, y_train, epochs=10, batch_size=1)
...
#                 synthetic_images = synthetic_images.reshape(1, time_steps, synthetic_images.shape[1], synthetic_images.shape[2], 3)
...
#                     ax.axis('off')
#                     ax.set_title(f"Predicted Time Step {i}")
#                 plt.show()
#             except Exception as e:
#                 print(f"Error processing {filename}: {e}")
